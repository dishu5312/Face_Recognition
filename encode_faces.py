...
ap.add_argument("-d", "--dataset", required=False, default="Dataset", help="path to input dataset directory")
ap.add_argument("-e", "--encodings-file", required=False, default='encodings/dishu.pkl', help="path to serialized db of facial encodings")
