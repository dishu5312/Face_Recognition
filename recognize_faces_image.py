...
example_images = [
    ...
    "examples/example_02.jpg",
    "examples/example_03.jpg",
    "examples/example_04.jpg",
    "examples/example_05.jpeg",
    "examples/example_06.png"
]
ap = argparse.ArgumentParser()
ap.add_argument("-i", "--image", required=False,
                default=example_images[4],
                help="path to input image")
ap.add_argument("-e", "--encodings-file", required=False, default='encodings/dishu.pkl',
